...
1.5			RefineTo
0.75			CoarsenFrom
currentsheet -polar		StringRefine
0.5			CoarsenLimit
0.5			RefineLimit
1.5			MaxResolution
...
rbody x_earth y_earth z_earth		NamePars
